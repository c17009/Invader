...
phina.define('MainScene', {
    ...
    init: function () {
        ...
        for(let i = 0; i<5; i++){
            for(let z = 0; z<8; z++){
                Enemy(this.gridX.span(5+2*z), this.gridY.span(3+4*i), ENEMY_ASSETS[1]).addChildTo(this.enemyGroup);
            }
        }
...
phina.define('EnemyGroup', {
    ...
    update: function (app) {
        ...
        //ミサイル発射
        if(this.missileTime/this.missileInterval >= 1){
            this.children.forEach(enemy => {
